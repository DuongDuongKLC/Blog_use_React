...
var Dayly_converstations = function (_React$Component) {
    _inherits(Dayly_converstations, _React$Component);

    function Dayly_converstations() {
        var _ref;

        var _temp, _this, _ret;

        _classCallCheck(this, Dayly_converstations);

        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
        }

        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Dayly_converstations.__proto__ || Object.getPrototypeOf(Dayly_converstations)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
            data_status: []
    ...
    _createClass(Dayly_converstations, [{
    ...
    return Dayly_converstations;
}(React.Component);

export default Dayly_converstations;