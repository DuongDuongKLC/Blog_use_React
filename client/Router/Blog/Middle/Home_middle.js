...
var Home_middle = function (_React$Component) {
    _inherits(Home_middle, _React$Component);
    ...
    function Home_middle() {
        ...
        _classCallCheck(this, Home_middle);

        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
        }

        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Home_middle.__proto__ || Object.getPrototypeOf(Home_middle)).call.apply(_ref, [this].concat(args))), _this), _this.url = {}, _this.state = {
            data_posts: []
        }, _this.getStatus = function () {
            axios.post('/data_post').then(function (response) {
                var data_posts = response.data;
                _this.setState({ data_posts: data_posts.data });
            }).catch(function () {
                console.log('Somthing wrong');
            });
        }, _this.disPlayStatus = function (data_posts) {
            if (!data_posts.length) return null;
            return data_posts.map(function (posts, index) {
                return React.createElement(
                    'div',
                    { 'class': 'mt-4 ml-5 mr-5 h(300) bdc(Black) row rounded' },
                    React.createElement('img', { src: posts.url_picture, 'class': 'h-100 w(350) bdc-rt(Black) overflow-hidden rounded', alt: '', srcset: '' }),
                    React.createElement(
                        'div',
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                ...
                                React.createElement(
                                    Link,
                                    { to: '/bai-viet/' + posts.stt_status, 'class': 'ff(Lemon) c(Black) fz(15) font-weight-bold float-left pt-sm-3 pl-5 hov(c-Black):h' },
                                    ' ',
                                    posts.title_status,
                                    ' '
                                )
