    ...
    getStatus = () =>{
        axios.post('/data_status')
            .then((response)=>{
                ...
                const data_show = data_status.data[4];
                this.setState({data_status: [data_show]})
            })
            .catch(()=>{
                    ...
                    <div class="float-left h-100 w-100">
                        <div class="title_child h(100pc) wcalc(calcpc200) float-left">
                            <div class="w(300) float-left ml-5">
                                <img src="/bai_viet" class="h(40) w(40) float-left mt-1 ml-2 rounded-circle bdc(Black)" alt="" srcset=""/>
                                <a class="ff(Lemon) c(Black) fz(15) font-weight-bold pt-3 hov(c-Black):h float-right"> {sta.title_status} </a>
                            </div>
                        </div>
