...
var Content1 = function (_React$Component) {
    _inherits(Content1, _React$Component);
    ...
    function Content1() {
        ...
        _classCallCheck(this, Content1);

        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
        }

        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Content1.__proto__ || Object.getPrototypeOf(Content1)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
            data_status: []
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                ...
                                React.createElement(
                                    Link,
                                    { to: '/kali-linux/' + status.stt_status, 'class': 'ff(Lemon) c(Black) fz(15) font-weight-bold float-left pt-sm-3 pl-5 hov(c-Black):h' },
                                    ' ',
                                    status.title_status,
                                    ' '
                                )
